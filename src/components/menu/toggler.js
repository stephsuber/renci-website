...
export const Toggler = ({ active, ...props }) => {
    return (
        <Wrapper { ...props }>
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28px" height="24px" viewBox="0 0 28 24" stroke={ active ? 'red' : 'white' } strokeWidth="4" strokeLinecap="round">
